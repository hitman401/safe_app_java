...
//	 static { System.loadLibrary("safe_app"); }
	 ...
	 */
	public static native void appUnregistered(byte[] bootstrapConfigPtr, CallbackVoid oDisconnectNotifierCb, CallbackResultApp oCb);
	 ...
	 */
	public static native void accessContainerFetch(long app, CallbackResultContainerPermissionArrayLen oCb);
	 ...
	 * Callback parameters: user data, error code
	 */
	public static native void mdataEntriesInsert(long app, long entriesH, byte[] keyPtr, byte[] valuePtr, CallbackResult oCb);
	 ...
	 */
	public static native void mdataEntriesGet(long app, long entriesH, byte[] keyPtr, CallbackResultByteArrayLenLong oCb);
	 ...
	 */
	public static native void mdataEntriesForEach(long app, long entriesH, CallbackByteArrayLenByteArrayLenLong oEachCb, CallbackResult oDoneCb);
	 ...
	 * Callback parameters: user data, error code
	 */
	public static native void mdataEntryActionsInsert(long app, long actionsH, byte[] keyPtr, byte[] valuePtr, CallbackResult oCb);
	 ...
	 * Callback parameters: user data, error code
	 */
	public static native void mdataEntryActionsUpdate(long app, long actionsH, byte[] keyPtr, byte[] valuePtr, long entryVersion, CallbackResult oCb);
	 ...
	 * Callback parameters: user data, error code
	 */
	public static native void mdataEntryActionsDelete(long app, long actionsH, byte[] keyPtr, long entryVersion, CallbackResult oCb);
